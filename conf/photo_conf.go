...
func InitPhotoConf() {
	...
	logger.Info("", "ReqScheduleConf", *ReqScheduleConf)
	logger.Info("", "Seed", *Seed)
	logger.Info("", "Width", *Width)
	logger.Info("", "Height", *Height)
	logger.Info("", "Scale", *Scale)
	logger.Info("", "DDIMSteps", *DDIMSteps)
	logger.Info("", "UsePreLLM", *UsePreLLM)
	logger.Info("", "UseSr", *UseSr)
	logger.Info("", "ReturnUrl", *ReturnUrl)
	logger.Info("", "AddLogo", *AddLogo)
	logger.Info("", "Position", *Position)
	logger.Info("", "Language", *Language)
	logger.Info("", "Opacity", *Opacity)
	logger.Info("", "LogoTextContent", *LogoTextContent)
